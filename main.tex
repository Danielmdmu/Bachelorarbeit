...
\newminted[GoCode]{go}{linenos=true, xleftmargin=1cm}
\newminted[SwiftCode]{swift}{linenos=true, xleftmargin=1cm, escapeinside=@@}
\newmintedfile[InputGo]{go}{linenos=true, xleftmargin=1cm}
\newmintedfile[InputSwift]{swift}{linenos=true, xleftmargin=1cm}
...
\newcommand{\CodeRef}[1]{Codebeispiel \ref{#1}}
\newcommand{\SeiteRef}[1]{Seite \ref{#1}}
\newcommand{\BildRef}[1]{Abbildung \ref{#1}}
\newcommand{\TabRef}[1]{Tabelle \ref{#1}}
\newcommand{\KapitelRef}[1]{Kapitel \ref{#1}}
\newcommand{\AbschnittRef}[1]{Abschnitt \ref{#1}}
